...
public class Carta {
	...
	private boolean isJolly;					//controllo se è Jolly (il Jolly o il 2)
	private boolean isPin;						//il 2, isPin è sempre true, se lo uso come 2 gli setto il isJolly a false, sennò a true
	private int numero;							//uso due variabili numero perchè l'asso può essere attaccato vicino al 2 o al K
